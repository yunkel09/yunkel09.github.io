...
Dado que las lineas son casi paralelas se puede concluir que no hay una
interacción entre los factores

La interacción entre factores se puede observar cuando las líneas del diagrama
se cruzan o tienen pendientes muy diferentes lo cual indica que la variable
respuesta se comporta diferente al variar un factor dependiendo del valor del
otro factor.
