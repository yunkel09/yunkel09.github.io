...
diag_03 <- diag_02 |>
 ...
 distinct(msisdn_dd, srvy_id, .keep_all = TRUE)                     # <11>
```
...
11. Remover duplicados, dejando únicamente un usuario y una encuesta única.

La tabla @tbl-diagnostico muestra los primeros cinco registros y la totalidad
de sus columnas.
